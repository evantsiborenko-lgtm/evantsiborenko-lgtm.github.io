...
Обновление 2026-06-27 v6.4:
- добавлен фоновый трек A_Ribbon_Untied.mp3 в assets/audio;
- добавлена кнопка включения фоновой музыки с уровнем громкости 20%;
- чёрная sticky-полоса шапки растянута на всю ширину экрана;
- сохранено ручное включение звука без autoplay.


Обновление 2026-06-27 v6.5:
- Убрана отдельная плавающая кнопка фоновой музыки.
...
Обновление v6.7:
- блок форматов переименован в «Понятные форматы работы и ориентиры по стоимости»;
- цены заменены на ориентиры/диапазоны;
- в карточки тарифов добавлено количество правок;
- уточнена защитная формулировка про правки и смену ТЗ;
- обновлён FAQ по правкам и JSON-LD offers.


Обновление v6.8:
- исправлен текст в white-label блоке: «приносите продукт» заменено на «присылаете материалы по товару»;
- добавлен отдельный tablet portrait override для sticky-header на вертикальных планшетах.


Обновление v6.9:
- в шапке сайта подключена premium gold-версия логотипа KVSvideo;
